...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    LeftSideMenuViewController *leftSideMenuViewController = [mainStoryboard instantiateViewControllerWithIdentifier:@"LeftSideMenuViewController"];
    leftSideMenuViewController.isSkiped = NO;
    
    NewsFeedViewController *navigation = [mainStoryboard instantiateViewControllerWithIdentifier:@"NewsFeedViewController"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.dci.rottichennai" in the application's documents directory.
